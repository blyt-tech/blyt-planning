/* Spike M Stage 6 negative test — blob-truncation shim. */

#include "embed/blyt32_coroutine.h"
#include "embed/det_neg_blob_truncation.h"
...
const char          *cart_workload_name = "det_neg_blob_truncation";

void cart_workload_init(void)
{
    cart_wrapper_lua      = blyt32_coroutine_lua;
    cart_wrapper_lua_len  = blyt32_coroutine_lua_len;
    cart_workload_lua     = det_neg_blob_truncation_lua;
    cart_workload_lua_len = det_neg_blob_truncation_lua_len;
}
